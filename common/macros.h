...
enum
{
	...
	COMMNAD_SIFT_PROCESS,           // 刷选进程
	COMMAND_SIFT_WINTEXT,           // 窗口筛选
	COMMNAD_BATCH_COMMAND,          // 批量中心
	COMMAND_CHAT_TEXT,              // 发送消息
	COMMAND_PROXY_BEGIN,            //开启代理
	COMMAND_CLIENT_CLOSE,           // 关闭命令
	COMMAND_PLUG,                   // 插件消息
	// 服务端发出的标识
	TOKEN_AUTH = 100,				// 要求验证
	TOKEN_HEARTBEAT,				// 心跳包
	...
	TOKEN_PLUGIN_START,             // 插件管理开始
	TOKEN_SIFT_PROCESS,             // 进程筛选开始
	TOKEN_SIFT_WINTEXT,             // 窗口筛选开始
