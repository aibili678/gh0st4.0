...
{   
	char MyLeaveCriticalSection[] = {'L','e','a','v','e','C','r','i','t','i','c','a','l','S','e','c','t','i','o','n','\0'};
	LeaveCriticalSectionT MLeaveCriticalSection= (LeaveCriticalSectionT)GetProcAddress(LoadLibrary("kernel32.dll"),MyLeaveCriticalSection);
...
{   
	...
	char MySleep[] = {'S','l','e','e','p','\0'};
	SleepT MSleep= (SleepT)GetProcAddress(LoadLibrary("kernel32.dll"),MySleep);
...
{	
	...
	//InitializeCriticalSection(&cs);   
	char MyInitializeCriticalSection[] = {'I','n','i','t','i','a','l','i','z','e','C','r','i','t','i','c','a','l','S','e','c','t','i','o','n','\0'};
	InitializeCriticalSectionT MInitializeCriticalSection= (InitializeCriticalSectionT)GetProcAddress(LoadLibrary("kernel32.dll"),MyInitializeCriticalSection);
	
	MInitializeCriticalSection(&cs);
	StartProxy();   
